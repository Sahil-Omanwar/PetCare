  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-teal-400 to-blue-500 p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-5xl font-bold text-white text-center mb-8">About Us</h1>
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="flex flex-col md:flex-row items-center md:space-x-8">
            ...
            <div className="md:w-1/2">
              ...
              <h2 className="text-4xl font-bold text-teal-600 mb-4">Who We Are</h2>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <h3 className="text-2xl font-bold text-teal-600 mb-4">Experienced Vets</h3>
            <p className="text-gray-700">
              Our certified veterinarians are available 24/7 to provide the best medical care for your pets.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <h3 className="text-2xl font-bold text-teal-600 mb-4">Quality Care</h3>
            <p className="text-gray-700">
              We ensure that all our services are designed to offer maximum comfort and care for your pets.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <h3 className="text-2xl font-bold text-teal-600 mb-4">Trusted Network</h3>
            <p className="text-gray-700">
